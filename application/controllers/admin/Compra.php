...
class Compra extends CI_Controller {
    ...
    public function index() {
        ...
        $data['URLADICIONAR'] = site_url('admin/compra/adicionar');
        $data['URLLISTAR'] = site_url('admin/compra');

        $data['compras'] = $this->CompraM->get_all()->result();

        $this->parser->parse('admin/compra', $data);
    }
    ...
    public function adicionar() {
        ...
        $this->parser->parse('admin/compra_form', $data);
    }
    ...
    public function salvar() {
        ...
        if (!$erros) {
            ...
            redirect('admin/compra');
        } else {
            $this->session->set_flashdata('erro', nl2br($mensagem));

            redirect('admin/compra/adicionar');
        }
    }
    ...
    public function visualizar($idcompra) {
        ...
        $this->parser->parse('admin/compra_visualizar', $data);
    }
