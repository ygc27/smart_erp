<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <?php echo form_open(base_url('funcionario/compra/salvar'), array('data-toggle' => 'validator')); ?>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="callout callout-info">
                                <h4>Instruções</h4>
                                <ul>
                                    <li>Verificar as informações antes de criar a compra. A compra uma vez feita não poderá ser alterada.</li>
...
<script>
    ...
    function adicionar_produto(idproduto) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>funcionario/compra/get_produto/' + idproduto + '/' + total_linha,
            beforeSend: function () {
