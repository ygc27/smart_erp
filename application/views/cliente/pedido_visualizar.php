<div class="content-wrapper">
    ...
    <div class="row">
        <?php if ($status_pedido == 1 || $status_pedido == 2): ?>
            <div class="col-md-12">
                ...
                <div class="col-xs-12">
                    <h2 class="page-header">
                        ...
                        <div class="pull-right no-print" style="margin-top: -10px;">
                            <a href="<?php echo site_url('cliente/fatura/imprimir_pedido/' . $idpedido); ?>" target="_blank" class="btn btn-success" title="Imprimir" data-toggle="tooltip" data-placement="top">
