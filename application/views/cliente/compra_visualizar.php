<div class="content-wrapper">
    ...
    <section class="invoice">
            ...
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    <div class="pull-right no-print" style="margin-top: -10px;">
                        <a href="<?php echo site_url('cliente/fatura/imprimir_compra/' . $idvenda); ?>" target="_blank" class="btn btn-success" title="Imprimir" data-toggle="tooltip" data-placement="top">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                <b>Código da Fatura:</b> <?php echo $codigo_venda; ?><br/>
