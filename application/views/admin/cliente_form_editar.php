                            ...
                            <?php if ($tipo_perfil == 'pf'): ?>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control cpf" name="cpf" id="cpf" value="{cpf}" readonly />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="cliente" id="cliente" value="{nome}" data-error="O campo cliente é obrigatorio" required />
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            ...
                            <?php else: ?>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control cnpj" name="cnpj" id="cnpj" value="{cnpj}" readonly />
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>

                                <div class="form-group">
                                    <label for="cliente">Empresa <span class="required">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="fa fa-building-o fa-fw"></i>
                                        </div>
                                        <input type="text" class="form-control" name="cliente" id="cliente" value="{nome}" data-error="O campo empresa é obrigatorio" required />
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="razao_social" id="razao_social" value="{razao_social}" data-error="O campo razão social é obrigatorio" required />
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="pessoa_contato" id="pessoa_contato" value="{pessoa_contato}" data-error="O campo pessoa/contato é obrigatorio" required />
                                    </div>
                                    <div class="help-block with-errors"></div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                        <img src="<?php echo $this->ClienteM->get_image_url('cliente', $idcliente); ?>" alt="...">
                                    </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="uf" id="uf" required>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control cep" name="cep_entrega" id="cep_entrega" maxlength="9" onblur="pesquisacep(this.value);" value="{cep_entrega}" data-error="O campo cep é obrigatorio" required />
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="endereco_entrega" id="endereco_entrega" value="{endereco_entrega}" data-error="O campo endereço é obrigatorio" required />
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="numero_entrega" id="numero_entrega" value="{numero_entrega}" data-error="O campo número é obrigatorio" required />
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="complemento_entrega" id="complemento_entrega" value="{complemento_entrega}" data-error="O campo complemento é obrigatorio" required />
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="bairro_entrega" id="bairro_entrega" value="{bairro_entrega}" data-error="O campo bairro é obrigatorio" required />
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="cidade_entrega" id="cidade_entrega" value="{cidade_entrega}" data-error="O campo cidade é obrigatorio" required />
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="uf_entrega" id="uf_entrega" data-error="Selecione um estado" required>
                                <option value="">Selecione um estado</option>
                                <option value="AC" {uf_entrega_AC}>Acre</option>
                                <option value="AL" {uf_entrega_AL}>Alagoas</option>
                                <option value="AP" {uf_entrega_AP}>Amapá</option>
                                <option value="AM" {uf_entrega_AM}>Amazonas</option>
                                <option value="BA" {uf_entrega_BA}>Bahia</option>
                                <option value="CE" {uf_entrega_CE}>Ceará</option>
                                <option value="DF" {uf_entrega_DF}>Distrito Federal</option>
                                <option value="ES" {uf_entrega_ES}>Espírito Santo</option>
                                <option value="GO" {uf_entrega_GO}>Goiás</option>
                                <option value="MA" {uf_entrega_MA}>Maranhão</option>
                                <option value="MT" {uf_entrega_MT}>Mato Grosso</option>
                                <option value="MS" {uf_entrega_MS}>Mato Grosso do Sul</option>
                                <option value="MG" {uf_entrega_MG}>Minas Gerais</option>
                                <option value="PA" {uf_entrega_PA}>Pará</option>
                                <option value="PB" {uf_entrega_PB}>Paraíba</option>
                                <option value="PR" {uf_entrega_PR}>Paraná</option>
                                <option value="PE" {uf_entrega_PE}>Pernambuco</option>
                                <option value="PI" {uf_entrega_PI}>Piauí</option>
                                <option value="RJ" {uf_entrega_RJ}>Rio de Janeiro</option>
                                <option value="RN" {uf_entrega_RN}>Rio Grande do Norte</option>
                                <option value="RS" {uf_entrega_RS}>Rio Grande do Sul</option>
                                <option value="RO" {uf_entrega_RO}>Rondônia</option>
                                <option value="RR" {uf_entrega_RR}>Roraima</option>
                                <option value="SC" {uf_entrega_SC}>Santa Catarina</option>
                                <option value="SP" {uf_entrega_SP}>São Paulo</option>
                                <option value="SE" {uf_entrega_SE}>Sergipe</option>
                                <option value="TO" {uf_entrega_TO}>Tocantins</option>
                            </select>
                            <div class="help-block with-errors"></div>
                        </div>
                    </div>
