<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <?php echo form_open(base_url('admin/venda/salvar'), array('data-toggle' => 'validator', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <div class="callout callout-info">
                                <h4>Instruções</h4>
                                <ul>
                                    <li>Verificar os produtos adicionados antes de criar a venda. O produto que foi adicionado não pode ser editado mais tarde, mas outras informações são editáveis.</li>
                                    <li>Você pode adicionar um produto pela busca por código de barras ou selecionando a categoria e subcategoria do produto.</li>
...
<script>
    ...
    function adicionar_produto(idproduto) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/venda/get_produto_selecionado/mouse/' + idproduto + '/' + total_linha,
    ...
    function barcode_input(e, codigo_produto) {
        ...
        if (key == 13) {
            ...
            // Lista detalhes do Produto
            $.ajax({
                url: '<?php echo base_url(); ?>admin/venda/get_produto_selecionado/barcode/' + codigo_produto + '/' + total_linha,
                success: function (result)
                {
                    $('#entrada_vendas').append(result);
                    calcular_valor_total();
    ...
    function get_produto(tipo, id_categoria) {
        $.ajax({
            url: '<?php echo base_url(); ?>admin/venda/get_produtos/' + tipo + '/' + id_categoria,
            success: function (result)
            {
        ...
        {
            $.ajax({
                url: '<?php echo base_url(); ?>admin/venda/get_subcategoria/' + id_categoria,
                success: function (result)
                {
    ...
    jQuery(document).ready(function () {
        ...
        $("#id_cliente").change(function () {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/venda/get_desconto',
                type: 'POST',
                data: {
