    ...
    <section class="invoice">
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    <i class="fa fa-globe"></i> <?php echo $nome_empresa; ?>

                    <div class="pull-right no-print" style="margin-top: -10px;">
                        <a href="<?php echo site_url('admin/fatura/imprimir_compra/' . $idcompra); ?>" target="_blank" class="btn btn-success" title="Imprimir" data-toggle="tooltip" data-placement="top">
        ...
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                De
                <address>
                    <strong><?php echo $nome_empresa; ?></strong>
                    <br/>
                    <?php
                    $endereco_empresa = explode('-', $endereco_empresa);
                    echo $endereco_empresa[0];
                    ?>
                    <br/>
                    <?php echo $endereco_empresa[1] . '-' . $endereco_empresa[2] ?>
                    <br/>
