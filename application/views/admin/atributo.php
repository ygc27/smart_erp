<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo site_url('admin/atributo'); ?>"> Atributos</a>
            </li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Listando Atributos</h3>
                                ...
                                foreach ($atributos as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <?php
                                            if ($row->idatributo > 0)
                                                echo $this->db->get_where('tipo_atributo', array('idtipoatributo' => $row->idtipoatributo))->row()->nome;
                                            ?>
                                        </td>
                                        <td class="text-center" style="width: 80px;">
                                            <a href="<?php echo site_url('admin/atributo/editar/' . $row->idatributo); ?>" class="btn btn-primary btn-sm" title="Editar" data-toggle="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>&nbsp;
                                            <button onclick="showDeleteModal('<?php echo base_url(); ?>admin/atributo/excluir/<?php echo $row->idatributo; ?>');" 
