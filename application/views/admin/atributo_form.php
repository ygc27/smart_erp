<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo site_url('admin/atributo'); ?>"> Atributo</a>
            </li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php echo form_open(base_url('admin/atributo/salvar'), array('data-toggle' => 'validator')); ?>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"> Atributo - {ACAO}</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="idtipoatributo" id="idtipoatributo" class="form-control select2" data-error="Selecione um tipo de atributo" required>
                                    ...
                                    {BLC_TIPOATRIBUTO}
                                    <option value="{IDTIPOATRIBUTO}" {sel_idpai}>{NOMETIPOATRIBUTO}</option>
                                    {/BLC_TIPOATRIBUTO}
                                </select>
                                <div class="help-block with-errors"></div>
                            </div>
