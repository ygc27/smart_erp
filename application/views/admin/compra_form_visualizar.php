            ...
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $this->db->select('*');
                        $this->db->from('compra_item');
                        $this->db->where('idcompra', $idcompra, FALSE);
                        $itens = $this->db->get()->result();
                        ...
                        foreach ($itens as $row):
                            ...
                            <tr>
                                ...
                                <td><?php echo $moeda . ' ' . number_format($row->preco_unitario * $row->quantidade, 2, ',', '.'); ?></td>
                            </tr>
                            <?php
                        endforeach;
                        ?>
            ...
            <div class="col-md-4">
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <th>Valor Total:</th>
                            <td class="text-right"><?php echo $moeda . ' ' . $this->db->get_where('pagamento', array('idcompra' => $idcompra))->row()->valor; ?></td>
