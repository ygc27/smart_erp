<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo site_url('admin/perfil'); ?>"><i class="fa fa-user"></i> Perfil</a>
            </li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?php echo form_open(base_url('admin/perfil/salvar'), array('data-toggle' => 'validator', 'enctype' => 'multipart/form-data')); ?>
                        <input type="hidden" name="idadmin" id="idadmin" value="{idadmin}" />
                        ...
                        <div class="form-group">
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                    <img src="<?php echo $this->PerfilM->get_image_url('admin', $idadmin); ?>" alt="...">
                                </div>
            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?php echo form_open(base_url('admin/perfil/salvar_senha'), array('data-toggle' => 'validator')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" name="nova_senha" id="nova_senha" data-error="O campo nome senha é obrigatorio" required />               
                            </div>
                            <div class="help-block with-errors"></div>
                        </div>
