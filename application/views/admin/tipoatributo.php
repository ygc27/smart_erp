    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Listando Tipos de Atributos</h3>
                    ...
                    <div class="tooltip-demo">
                        <table class="table table-bordered table-striped dataTable" cellspacing="0" width="100%">
                            ...
                            <tbody class="text-center">
                                <?php
                                foreach ($tipo_atributo as $row):
                                    ?>
                                    <tr>
                                        <td class="text-left"><?php echo $row->nome; ?></td>
                                        <td class="text-center" style="width: 80px;">
                                            <a href="<?php echo site_url('admin/tipoatributo/editar/' . $row->idtipoatributo); ?>" class="btn btn-primary btn-sm" title="Editar" data-toggle="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>&nbsp;
                                            <button onclick="showDeleteModal('<?php echo base_url(); ?>admin/tipoatributo/excluir/<?php echo $row->idtipoatributo; ?>');" 
