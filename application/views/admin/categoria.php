    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Listando Categoria</h3>
                                ...
                                foreach ($categorias as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 80px;">
                                            <a href="<?php echo site_url('admin/categoria/editar/' . $row->idcategoria); ?>" class="btn btn-primary btn-sm" title="Editar" data-toggle="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>&nbsp;
                                            <button onclick="showDeleteModal('<?php echo base_url(); ?>admin/categoria/excluir/<?php echo $row->idcategoria; ?>');" 
