...
<html>
    <head>
        ...
        <title>Smart ERP | Fatura Venda</title>
            ...
            <section class="invoice">
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-4 invoice-col">
                        ...
                        <b>Data da Fatura:</b> <?php echo dateMySQL2BR($data_cadastro); ?><br/>
                    </div>
                </div>
                                        ...
                                        <td><?php
                                            foreach ($vendas as $valor):
                                                ...
                                                <div class="form-group">
                                                    <label>
                                                        <?php echo $nomeAtributo . ' (' . $qtdeVendas . ')'; ?>
                                                    </label>
                                                <?php endforeach; ?>
                                        </td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                            <?php
                            $formaPagamento = $this->db->get_where('pagamento', array('idvenda' => $idvenda))->row()->forma_pagamento;
