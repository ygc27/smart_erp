            ...
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    <div class="pull-right no-print" style="margin-top: -10px;">
                        <a href="<?php echo site_url('admin/fatura/imprimir_venda/' . $idvenda); ?>" target="_blank" class="btn btn-success" title="Imprimir" data-toggle="tooltip" data-placement="top">
