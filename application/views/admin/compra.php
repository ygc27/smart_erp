                        ...
                        <table class="table table-bordered table-striped dataTable" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Código</th>
                                    <th>Fornecedor</th>
                                    <th class="text-center" style="width: 100px;">Cadastro</th>
                            ...
                            <tbody class="text-center">
                                ...
                                foreach ($compras as $row):
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 30px;"><?php echo date('d/m/y h:m:s', $cadastro); ?></td>
                                        <td class="text-center" style="width: 20px;">
                                            <a href="<?php echo site_url('admin/compra/visualizar/' . $row->idcompra); ?>" class="btn btn-info btn-sm" title="Visualizar" data-toggle="tooltip" data-placement="top">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
